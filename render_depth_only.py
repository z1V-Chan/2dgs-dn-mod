...
if __name__ == "__main__":
    ...
    parser.add_argument("--gs_path", default=None, type=str, help="Path to a file containing Gaussian crop information.")
    ...
    scene = Scene(dataset, gaussians, load_iteration=iteration, shuffle=False, crop_gs_path=args.gs_path)
    ...
    if not args.skip_mesh:
        ...
        if args.unbounded:
            ...
            name = 'fuse.ply'
            depth_trunc = (gaussExtractor.radius * 15.0) if args.depth_trunc < 0  else args.depth_trunc
